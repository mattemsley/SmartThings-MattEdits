...
definition (name: "Schlage Door/Window Sensor as Carbon Monoxide Detector v2", namespace: "mattemsley", author: "mattemsley") {
...
tiles(scale: 2) {
		multiAttributeTile(name:"carbonmonoxide", type: "lighting", width: 6, height: 4){
			tileAttribute ("device.smoke", key: "PRIMARY_CONTROL") {
				attributeState "clear", label:'${name}', icon:"st.alarm.carbon-monoxide.clear", backgroundColor:"#79b821"
				attributeState "detected", label:'${name}', icon:"st.alarm.carbon-monoxide.carbon-monoxide", backgroundColor:"#ff1f1f"
			}
		}
...
def result = null
if (value) {
result = createEvent(name: "carbonMonoxide", value: "clear", descriptionText: "$device.displayName carbon monoxide is clear")
} else {
result = createEvent(name: "carbonMonoxide", value: "detected", descriptionText: "$device.displayName carbon monoxide was detected!")
}
return result
}
